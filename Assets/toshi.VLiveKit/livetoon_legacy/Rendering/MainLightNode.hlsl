#ifndef MAINLIGHTNODE_INCLUDED
#define MAINLIGHTNODE_INCLUDED

void MainLightNode_float(out half3 direction, out half3 color, out half distanceAttenuation, out half shadowAttenuation)
{
