...
public class LegacyShaderConverterTool : EditorWindow
{
    private GameObject selectedObject;
    private Shader shaderToUse;

    [MenuItem("toshi/VLiveKit/LiveToon/Legacy Shader Converter")]
    public static void ShowWindow()
    {
        GetWindow<LegacyShaderConverterTool>("Legacy Shader Converter");
    }
